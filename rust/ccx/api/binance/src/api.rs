...
const V1_PING: &str = "/api/v3/ping";
const V1_TIME: &str = "/api/v3/time";
const V1_EXCHANGE_INFO: &str = "/api/v3/exchangeInfo";
...
impl Api {
    ...
    pub async fn ping(&self) -> LibResult<Pong> {
        self.client.get(V1_PING)?.send().await
    }
    ...
    pub async fn time(&self) -> LibResult<ServerTime> {
        self.client.get(V1_TIME)?.send().await
    }
    ...
    pub async fn exchange_info(&self) -> LibResult<ExchangeInformation> {
        self.client.get(V1_EXCHANGE_INFO)?.send().await
    }
    ...
    pub async fn ticker_24hr_all(&self) -> LibResult<Vec<TickerStats>> {
        self.client.get(V1_TICKER_24HR)?.send().await
    }
    ...
    pub async fn ticker_price_all(&self) -> LibResult<Vec<PriceTicker>> {
        self.client.get(V3_TICKER_PRICE)?.send().await
    }
    ...
    pub async fn ticker_book_all(&self) -> LibResult<Vec<BookTicker>> {
        self.client.get(V3_TICKER_BOOK_TICKER)?.send().await
    }
    ...
    // pub async fn ws_agg_trade<S>(
    //     &self,
    //     symbol: S,
    // ) -> Result<impl Stream<Item = Result<AggTradeEvent>>>
    // where
    //     S: AsRef<str>,
    // {
    //     let name = format!("{}@aggTrade", symbol.as_ref());
    //     self.client.web_socket(&name).await?.connect().await
    // }
    //
    // /// Trade Streams.
    // ///
    ...
    // pub async fn ws_mini_ticker<S>(
    //     &self,
    //     symbol: S,
    // ) -> Result<impl Stream<Item = Result<MiniTickerEvent>>>
    // where
    //     S: AsRef<str>,
    // {
    ...
    // pub async fn ws_mini_ticker_all(
    //     &self,
    // ) -> Result<impl Stream<Item = Result<Vec<MiniTickerEvent>>>> {
    ...
    // pub async fn ws_partial_depth<S>(
    //     &self,
    //     symbol: S,
    //     levels: OrderBookStreamLimit,
    ...
    // pub async fn ws_diff_depth<S>(
    //     &self,
    //     symbol: S,
    // ) -> Result<impl Stream<Item = Result<DiffOrderBookEvent>>>
    // where
    //     S: AsRef<str>,
    // {
    //     let name = format!("{}@depth@100", symbol.as_ref());
    //     self.client.web_socket(&name).await
    // }
