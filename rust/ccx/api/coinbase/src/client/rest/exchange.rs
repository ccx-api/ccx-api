...
impl<S> Clone for RestExchangeClient<S>
where
    S: CoinbaseExchangeSigner,
{
    fn clone(&self) -> Self {
    ...
    S: CoinbaseExchangeSigner,
{
    ...
    pub fn request(
        ...
        method: Method,
        endpoint: &str,
    ) -> CoinbaseResult<ExchangeRequestBuilder<S>> {
    ...
    pub fn get(&self, endpoint: &str) -> CoinbaseResult<ExchangeRequestBuilder<S>> {
        self.request(Method::GET, endpoint)
    }

    pub fn post(&self, endpoint: &str) -> CoinbaseResult<ExchangeRequestBuilder<S>> {
        self.request(Method::POST, endpoint)
    }

    pub fn put(&self, endpoint: &str) -> CoinbaseResult<ExchangeRequestBuilder<S>> {
