...
//
//     pub static CCX_BITSTAMP_API_PREFIX: &str = "CCX_BITSTAMP_API";
//
//     #[actix_rt::test]
//     async fn test_rate_limiter_queue() {
//         let signer = ApiCred::from_env_with_prefix(CCX_BITSTAMP_API_PREFIX);
...
//                 "interval_3__limit_5",
//                 RateLimiterBucket::default()
//                     .mode(RateLimiterBucketMode::BitstampDecrease)
//                     .interval(Duration::from_secs(3))
//                     .limit(5),
//             )
//             .start();
