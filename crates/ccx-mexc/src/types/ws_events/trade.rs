...
mod tests {
    ...
    fn it_deserializes_doc_example() {
        ...
        let expected = TradeEvent {
            event_time: MexcTimestamp::from_epoch_millis(1672515782136).unwrap(),
            symbol: SmartString::from("BNBBTC"),
            trade_id: 12345,
            price: dec!(0.001),
            quantity: dec!(100),
            trade_time: MexcTimestamp::from_epoch_millis(1672515782136).unwrap(),
